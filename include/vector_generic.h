...
#define DECLARE_VEC(type)                                                      \
    ...
    int type##_vec_init(type##_vec *v);                                      \
                                                                               \
    /* Push a value at the end of the vector. */                               \
    int type##_vec_push(type##_vec *v, const type *value);                   \
                                                                               \
     ...
     */                                                                        \
    int type##_vec_pop(type##_vec *v, type *dest);                           \
                                                                               \
    /* Create a vector from an array.                                          \
     * /!\ Performs a copy of the array.                                       \
     */                                                                        \
    int type##_vec_from_array(type##_vec *v, const void *array, size_t len);
...
#define IMPLEMENT_VEC(type)                                                    \
    ...
    int type##_vec_pop(type##_vec *v, type *dest) {                          \
        ...
        return 0;                                                              \
                                                                               ...
                                                                               \
    int type##_vec_from_array(type##_vec *v, const void *array,              \
                                size_t len) {                                  \
